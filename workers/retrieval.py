...
# Cache embedding function ở module level — load model 1 lần duy nhất
_embed_fn = None

def _get_embedding_fn():
    """
    Trả về embedding function. Model được load 1 lần và cache lại,
    tránh reload tốn ~10s mỗi lần gọi.
    """
    global _embed_fn
